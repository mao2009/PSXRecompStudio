//! Reserved slot for the `PSXCpu` branch / jump Rust migration (Issue #526).
//!
//! Intentionally empty: no exports and no implementation. The C++ code in
//! `src/psx_cpu_control.cpp` is the only implementation.
//!
...
//! `docs/development/rust-migrations/cpu/control.md`.
