...
public static class Ps1MemoryMap
{
    ...
    public const uint BiosStart = 0x1F000000;
    public const uint BiosEnd = 0x1F07FFFF;
    public const uint BiosSize = 0x80000;

    public const uint HardwareRegisterStart = 0x1F800000;
    public const uint HardwareRegisterEnd = 0x1F801FFF;

    public const uint SpuStart = 0x1F801C00;
    public const uint SpuEnd = 0x1F801DFF;

    public const uint BiosKernelStart = 0xFFFE0000;
    public const uint BiosKernelEnd = 0xFFFFFFFF;
    ...
    public static bool IsRam(uint address) => address <= RamEnd;
    ...
    public static bool IsKernelRam(uint address) => address >= BiosKernelStart;
