...
<#
.SYNOPSIS
    Approval state tracking for PR Merge Skill.

.DESCRIPTION
    Provides functions for managing approval states, including tracking
    approved commit SHAs and invalidation conditions. Enforces strict
    approval validation before merge.
...
function New-MergeApproval {
    ...
    $approval = @{
        ...
        ApprovedAt = (Get-Date).ToString("yyyy-MM-ddTHH:mm:ssZ")
        Notes = $Notes
        IsValid = $true
    }
...
function Test-MergeApprovalValid {
    <#
    .SYNOPSIS
...
function Invalidate-MergeApproval {
    <#
    .SYNOPSIS
    ...
    $Approval.InvalidatedAt = (Get-Date).ToString("yyyy-MM-ddTHH:mm:ssZ")
    $Approval.InvalidationReason = $Reason

    return $Approval
}

function Get-MergeApprovalSummary {
    <#
    .SYNOPSIS
...
Export-ModuleMember -Function @(
    'New-MergeApproval',
    'Test-MergeApprovalValid',
    'Invalidate-MergeApproval',
    'Get-MergeApprovalSummary',
    'Save-MergeApproval',
    'Get-MergeApproval'
)
